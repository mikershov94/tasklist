    ...
    return(
        <div className="container">
            <table className="tasklist">
                ...
                <tr>
                    <td className="tasklist__description">Описание задачи №1</td>
                    <td className="tasklist__status">Новый</td>
                    <td className="tasklist__priority">Низкий</td>
                    <td className="tasklist__date-plan">01.01.2019</td>
